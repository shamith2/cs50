...
int main(int argc, char **argv)
{
    ...
    if (argc != 2)
    {
        printf("\n:( Usage: ./credit number. Example: enter './credit 4012888888881881'.\n\n");
        return 1;
    }
    ...
    {
        printf("\n:( Enter positive amounts or check usage. Example: enter './credit 4012888888881881'.\n\n");
        return 2;
    }
